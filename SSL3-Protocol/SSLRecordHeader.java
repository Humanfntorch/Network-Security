...
public class SSLRecordHeader implements Serializable
{
    ...
    public static final byte SSL3_RT_ALERT = 0x15;
    public static final byte SSL3_RT_HANDSHAKE = 0x16;
    public static final byte SSL3_RT_APPLICATION_DATA = 0x17;
    public static final byte TLS1_RT_HEARTBEAT = 0x18;
